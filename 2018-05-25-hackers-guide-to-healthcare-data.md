...
>
> <u>medpagetoday.com / Show Me Where to Sign by Fred N. Pelzman, MD May 18, 2018</u>
...
I found the book Fixing Medical Prices very helpful in understanding the degree of complexity. Given Medicare accounts for a large portion of the annual healthcare spending in the United States, corresponding fee schedules of commercial payers are highly influenced by the CMS Physician Fee Schedule. Other Fee Schedules such as the one for Outpatient Prospective Payment System and PFS are primarily Fee for Service payment models.
...
Thanks for reading this far! Hopefully that gave you necessary and sufficient knowledge to wrangle healthcare data. Please make use of the datasets I have linked below, along with any other datasets that you have at your disposal to explore healthcare data on your own and try to verify my interpretations of it. These datasets are categorized as per the figure I have referenced above from the NEJM catalyst report. If you notice something wrong, confusing or missing, you can write to me at shkr@protonmail.com

| Clinical                                                     | Cost                                                         | Claims | Patient Generated                                           | Pharma                                                       | Patient Preference & Surveys                                 |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------ | ----------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [Physician Compare](https://www.medicare.gov/physiciancompare/) | [Healthcare Cost Institute (HCC)](http://www.healthcostinstitute.org/access-data/accessing-hcci-data-2018/) |        | [Crowdsourced Fitbit data](https://zenodo.org/record/53894) | [ClinicalTrials](https://www.clinicaltrials.gov/ct2/search)  | [HCUP](https://www.clinicaltrials.gov/ct2/search)            |
| [Hospital Compare](https://data.medicare.gov/data/hospital-compare) | [Physician Fee Schedule](https://www.cms.gov/apps/physician-fee-schedule/search/search-criteria.aspx) |        |                                                             | [VA Drug Side effects](https://vaww.cmop.med.va.gov/MedSafe_Portal/) | [LeapfrogGroup](https://vaww.cmop.med.va.gov/MedSafe_Portal/) |
| [UMLS Browser](https://www.nlm.nih.gov/research/umls/knowledge_sources/metathesaurus/) | ForwardHealth                                                |        |                                                             | [Uptodate Drug Information](https://www.uptodate.com/contents/table-of-contents/drug-information) |                                                              |
| [NPPES](https://npiregistry.cms.hhs.gov/)                    | [Inpatient Charges](https://data.cms.gov/Medicare-Inpatient/Inpatient-Prospective-Payment-System-IPPS-Provider/w2du-it53/data) |        |                                                             |                                                              |                                                              |
| Wikipedia Disease Pages                                      |                                                              |        |                                                             |                                                              |                                                              |
